<template>
  <div class="navbar">
    ...
    <div class="nav-tabs">
      <router-link to="/reccomend" class="tab-title"
        ><span>Recommend A Deck</span></router-link
      >
      <router-link to="/faq" class="tab-title"
        ><span>Resources & FAQ</span></router-link
      >
      <router-link v-if="isVerified" to="/edit" class="tab-title"
        ><span>Admin</span></router-link
      >
      <a href="https://discord.com/invite/T296j3Mw8K" class="tab-title"
        >Discord</a
      >
      <span class="tab-title" @click="toggleMode">{{ buttonText }}</span>
    </div>
    <v-app-bar-nav-icon
      class="moble-nav-menu"
    ...
    >
      <v-list nav dense>
        <v-list-item-group v-model="group">
          ...
          <v-list-item>
            <v-list-item-title
              ><span class="tab-title" @click="toggleMode">{{
                buttonText
